...
public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)
  {
    if (cmd.getName().equalsIgnoreCase("pet")) {
        ...
        else if (args.length == 2)
        {
          if (!args[0].equalsIgnoreCase("redeem")) {
            if (p.hasPermission("dpets.give")) {
              if ((args[1].equalsIgnoreCase("wolf")) || (args[1].equalsIgnoreCase("cat")) || (args[1].equalsIgnoreCase("iron_golem")) || (args[1].equalsIgnoreCase("creeper"))) {
                if (getConfig().contains(args[0].toLowerCase() + ".newpet")) {
                  List newpets = getConfig().getStringList(args[0].toLowerCase() + ".newpet");
      ...
      else if ((args[1].equalsIgnoreCase("wolf")) || (args[1].equalsIgnoreCase("cat")) || (args[1].equalsIgnoreCase("iron_golem")) || (args[1].equalsIgnoreCase("creeper"))) {
        if (getConfig().contains(args[0].toLowerCase() + ".newpet")) {
          List newpets = getConfig().getStringList(args[0].toLowerCase() + ".newpet");
          newpets.add(args[1].toLowerCase());
          getConfig().set(args[0].toLowerCase() + ".newpet", newpets);
